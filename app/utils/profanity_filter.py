"""
Profanity filter — blocks inappropriate words in user-generated content.
...
BAD_WORDS = {
    "2g1c", "2 girls 1 cup", "acrotomophilia", "anal", "anilingus", "anus", "arsehole",
    ...
    "ball sucking", "bangbros", "bangbus", "bareback", "barely legal", "barenaked",
    "bastard", "bastardo", "bastinado", "bbw", "bdsm", "beaner", "beaners", "beastiality",
    "bestiality", "bimbos", "birdlock", "bitch", "bitches", "black cock", "blonde action",
    "blowjob", "blow job", "blow your load", "blue waffle", "blumpkin", "bollocks",
    "bondage", "boner", "boob", "boobs", "booty call", "brown showers", "bukkake",
    ...
    "cleveland steamer", "clit", "clitoris", "clusterfuck", "cock", "cocks",
...
def contains_profanity(text: str) -> bool:
    ...
    Case-insensitive, checks for whole words and common variations.
    """
    if not text:
        return False
...
def filter_profanity(text: str, replacement: str = "***") -> str:
    ...
    for word in BAD_WORDS:
        pattern = r'\b' + re.escape(word) + r'\b'
        # Find matches in lowercase, but replace in original text
